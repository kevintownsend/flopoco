#ifndef IntMultiplier2_HPP
#define IntMultiplier2_HPP
#include <vector>
#include <sstream>
#include <gmp.h>
#include <mpfr.h>
 ...
 **/
class IntMultiplier2 : public Operator
{
public:
	/** 
	 * The constructor of the IntMultiplier2 class
	 ...
	 **/
	IntMultiplier2(Target* target, int wInX, int wInY);
	
	/** IntMultiplier2 destructor */
	~IntMultiplier2();
...
private:
    ...
    //Specific IntMultiplier2 methods
    /**
