...
namespace flopoco {
	...
	public:
		 ...
		 **/
		IntMultiplier(Target* target, int wX, int wY, int wOut=0, bool signedIO = false, float ratio = 1.0, map<string, double> inputDelays = emptyDelayMap,bool enableSuperTiles=false);
