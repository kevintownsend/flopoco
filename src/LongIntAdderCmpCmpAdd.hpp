#ifndef LongIntAdderCmpCmpAddCmpCmpAdd_HPP
#define LongIntAdderCmpCmpAddCmpCmpAdd_HPP
#include <vector>
#include <sstream>
#include <gmp.h>
#include <gmpxx.h>
...
namespace flopoco{
	...
	/** The LongIntAdderCmpCmpAdd class for experimenting with adders. 
	 */
	class LongIntAdderCmpCmpAdd : public Operator
	{
	public:
		/**
		 * The LongIntAdderCmpCmpAdd constructor
		 * @param[in] target the target device
		 * @param[in] wIn    the with of the inputs and output
		 * @param[in] inputDelays the delays for each input
		 **/
		LongIntAdderCmpCmpAdd(Target* target, int wIn, map<string, double> inputDelays = emptyDelayMap);
		/*LongIntAdderCmpCmpAdd(Target* target, int wIn);
		  void cmn(Target* target, int wIn, map<string, double> inputDelays);*/
	
		/**
		 *  Destructor
		 */
		~LongIntAdderCmpCmpAdd();
