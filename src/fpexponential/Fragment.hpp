...
class Fragment : public Operator
{
public:
	Fragment(Target* target, int length, Fragment* next_part);
	...
	virtual void generate(std::string prefix); /** this is where VHDL is written to the vhdl stream */
