...
namespace flopoco{
	...
	public:
		 ...
		 */
		FixFunctionByPiecewisePoly(Target* target, string func, int lsbIn, int msbOut, int lsbOut, int degree, bool finalRounding = true, bool plainStupidVHDL=false,  map<string, double> inputDelays = emptyDelayMap);
