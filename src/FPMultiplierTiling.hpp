#ifndef FPMultiplierTilingS_HPP
#define FPMultiplierTilingS_HPP
#include <vector>
#include <sstream>
#include <gmp.h>
#include <mpfr.h>
...
namespace flopoco{
	...
	/** The FPMultiplierTiling class */
	class FPMultiplierTiling : public Operator
	{
	public:
		 ...
		 **/
		FPMultiplierTiling(Target* target, int wEX, int wFX, int wEY, int wFY, int wER, int wFR, int norm,float ratio, int maxTimeInMinutes);

		/**
		 * FPMultiplierTiling destructor
		 */
		~FPMultiplierTiling();
	...
	private:
		...
		IntTilingMult* intmult_;     /**< The integer multiplier object */
