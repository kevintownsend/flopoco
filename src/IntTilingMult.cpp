							...
							while (d != NULL)
								{
									...
									xname.str("");
									xname << "x" << i << "_" << j;
									vhdl << tab << declare(xname.str(), multW+1) << " <= \"0\" & " << zg(fpadX,0) << " & " << "X" << range(startX, endX) << " & " << zg(bpadX,0) << ";" << endl;
									
									yname.str("");
									yname << "y" << i << "_" << j;
									vhdl << tab << declare(yname.str(), multH+1) << " <= \"0\" & " << zg(fpadY,0) << " & " << "Y" << range(startY, endY) << " & " << zg(bpadY,0) << ";" << endl;
