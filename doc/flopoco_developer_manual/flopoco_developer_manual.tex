...
Once this method is available, the command\\
 \texttt{flopoco FPAdder 8 23 TestBenchFile 500} \\
produces a test bench of 500 test vectors to exercise \texttt{\small FPAdder}. 
...
\end{itemize}
This double conversion is a bit cumbersome, but may be copy-pasted from one existing operator: Imitate \texttt{\small FPAdderSinglePath} or \texttt{\small FPExp}.
...
\subsubsection{Fully and weakly specified operators}
 Most operators should be fully specified: for a given input
  ...
  library is used in this case. Imitate \texttt{\small FPAdderSinglePath} in this case.
...
\texttt{\small FPAdderSinglePath.cpp} for examples. 
